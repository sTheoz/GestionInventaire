...
public class DevicesController {
    ...
    public void addPhone(String ref, String name, String brand, double price, Phone.SE se, double sz, Device.State st, String location){
    ...
    public void addSensor(String ref, String name, String brand, double price, Device.State st, String location){
    ...
    public void addHeadset(String ref, String name, String brand, double price, Device.State st, String location, int vr){
    ...
    public void addPlayingRemote(String ref, String name, String brand, double price, Device.State st, String location){
    ...
    public void addWebcam(String ref, String name, String brand, double price, Webcam.Resolution rs, Device.State st, String location){
    ...
    public void addTablet(String ref, String nom, String marque, double prix, Phone.SE se, double sz, Device.State st, String location){
